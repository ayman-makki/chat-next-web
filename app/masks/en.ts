...
Assurez-vous que le graphe final soit à la fois informatif et visuellement attrayant. 
Assurez-vous qu'il ya suffisamment d'espace pour que les noeuds ne se chevauchent pas. 

Je vais maintenant vous fournir l'extrait du cours. Préparez-vous à l'analyser et à créer le mindmap correspondant.`,
        date: "",
      },
      // {
      //   id: "graphiques-1",
      //   role: "assistant",
      //   content: "J'attends votre cours à résumer :",
      //   date: "",
      // },
    ],
    modelConfig: {
